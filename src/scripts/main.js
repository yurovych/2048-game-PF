...
document.addEventListener('keydown', (action) => {
  ...
  if (action.key === 'ArrowUp' && notEmpty === true) {
    ...
    for (let i = 0; i < cells.length; i++) {
      ...
      const mover = () => {
        if (
          ...
          cells[target].classList.add('animationSlideUp');
        }
  ...
  if (action.key === 'ArrowDown' && notEmpty === true) {
    let changesOccurred = false;
  ...
  if (action.key === 'ArrowLeft' && notEmpty === true) {
    let changesOccurred = false;
  ...
  if (action.key === 'ArrowRight' && notEmpty === true) {
    let changesOccurred = false;
  ...
  if (isFiled === true && isOriginal === true) {
